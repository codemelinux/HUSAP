...
import com.codemelinux.HUSAP.adapters.holders.LoadViewHolder;
import com.codemelinux.HUSAP.adapters.holders.PostViewHolder;
...
public class PostsAdapter extends BasePostsAdapter {
    ...
    private NavControl mainActivity;

    public PostsAdapter(final NavControl activity, SwipeRefreshLayout swipeContainer) {
        super(activity);
